...
def Connect_Mongo(todo_list_1):
    mongoClient = MongoClient("mongodb://192.168.0.92:27017")    # mongodb 접속
    database = mongoClient["toy_nosqls"]   # database 연결
    return database[todo_list_1]        # collection 작업
...
def User_name(collection):
    ...
    result_participants = collection.insert_one({"응시자 이름" : user_name})
